	...
	return (
		<>
			<main className="bg-adv w-full h-full mb-[50px]">
				<Navigation />
				<div id="kernel" className="w-full h-full">
					<div className="container relative mx-auto">
						...
						<div className="container absolute flex-col left-32 top-[200px] w-7/12 text-secondary">
							...
							<div className=" text-base py-5">
								BEYOND REALMS is happy to present its new hyper-realistic
								shooter - KERNEL. Two teams will fight on the territory of an
								abandoned bunker where abnormal things take place: the
								mysterious black sun changes the laws of physics.
							</div>
						</div>
						<div>
				...
				<div id="colony" className=" w-full h-full py-[100px]">
					<div className="container relative mx-auto">
						<img src="/img/img_colony.jpg" alt="Colony: Code Red" />
						<div className="container absolute flex-col left-32 top-[150px] w-7/12 text-secondary">
				...
				<div id="shmooter" className="w-full h-full">
					<div className="container relative mx-auto">
						...
						<div className="container absolute flex-col left-32 top-[200px] w-7/12 text-secondary">
							...
							<div className=" text-base">
								...
								blazing? Then the Shmooter game cartoony world of lawlessness is
								waiting for you!
							</div>
							<br />
							<div className=" text-base">
								Shoot robots in front of a fantastic urban landscape, move
								around the base through portals looking for weapons and enemies
								to kill, dance around with a shield like no one is pointing
								their guns at you!
							</div>
							<br />
							<div className=" text-base">
				...
				<div id="island" className="w-full h-full py-[100px]">
					<div className="container relative mx-auto">
						<img src="/img/img_island.jpeg" alt="Island Assault" />
						<div className="container absolute flex-col left-32 top-[170px] w-7/12 text-secondary">
							...
							<div className=" text-base">
								A group of people have arrived on your island and have decided
								to take over the island and have declared a fight against you.
								In order to retain leadership on the island you have to fight
							...
							<div>
								...
								collect medical supplies and use a variety of weapons. Show who
								is a real boss here! You got an amazing chance that can&lsquo;t
								be missed! Being on an industrial island full of objects that
								you can hide behind you can&lsquo;t help yourself getting
								involved into the game because everything here is made specially
								for that!
							</div>
						</div>
						<div className="relative">
				...
				<div id="safe_night" className="w-full h-full">
					<div className="container relative mx-auto">
				...
				<div id="ghost_mansion" className="w-full h-full py-[100px]">
					<div className="container relative mx-auto">
						<img src="/img/img_ghost_mansion.jpeg" alt="Ghost Mansion" />
						<div className="container absolute flex-col left-32 top-[160px] w-7/12 text-secondary">
							...
							<div className=" text-base">
								Ghost busters have arrived at an abandoned mansion that holds
								many secrets and mysteries! Otherworldly creatures have filled
								this place, and now you need to free the house from their
								grasping clutches! But ghosts don&lsquo;t know yet that you are
								brave ghost hunters with weapons hanging around your shoulders.
								But be careful - ghosts are extremely cunning
							</div>
							<br />
							<div>
				...
				<div id="space_battle" className=" w-full h-full">
					<div className="container relative mx-auto">
						...
						<div className="container absolute flex-col left-32 top-[200px] w-7/12 text-secondary">
							...
							<div className=" text-base">
								Feel like a soldier defending a space station from armed
								invaders. There is endless space and rain of meteorites outside,
								and there is the most modern spaceship around you. You can
								navigate the station using portals, find the latest blasters,
								shields and first aid kits to restore health, and learn to walk
				...
				<div id="space_battle2" className="w-full h-full py-[100px]">
					<div className="container relative mx-auto">
						...
						<div className="container absolute flex-col left-32 top-[140px] w-7/12 text-secondary">
							...
							<br />
							<div>
								Alien invaders are trying to take over your station. The good
								news is that you have a new weapon in your arsenal. And
								teleporters will help you get to other floors of your station.
							</div>
							<br />
							<div>
								Battle against your friends in every man for himself mode or
								team against team. And try not to fly into outer space.
							</div>
						</div>
						<div className="relative">
							<div className="container absolute flex bottom-[150px] place-content-center gap-x-6 text-sm text-secondary">
